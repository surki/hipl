/* $USAGI: netdb.h,v 1.3 2001/01/26 07:45:25 yoshfuji Exp $ */
...
extern int rcmd_af __P ((char **__restrict __ahost, unsigned short int __rport,
			 __const char *__restrict __locuser,
			 __const char *__restrict __remuser,
			 __const char *__restrict __cmd, int *__restrict __fd2p,
			 sa_family_t __af));
...
/* This is the equivalent function where the protocol can be selected
   and which therefore can be used for IPv6.  */
extern int rexec_af __P ((char **__restrict __ahost, int __rport,
			 __const char *__restrict __name,
			 __const char *__restrict __pass,
			 __const char *__restrict __cmd,
			 int *__restrict __fd2p,
...
/* This is the equivalent function where the protocol can be selected
   and which therefore can be used for IPv6.  */
extern int ruserok_af __P ((__const char *__rhost, int __suser,
			   __const char *__remuser, __const char *__locuser,
			   sa_family_t __af));
...
/* This is the equivalent function where the protocol can be selected
   and which therefore can be used for IPv6.  */
extern int rresvport_af __P ((int *__alport, sa_family_t __af));
#endif
...
# define AI_V4MAPPED	0x0100	/* IPv4-mapped addresses are acceptable. */
# define AI_ALL		0x0200	/* Return both IPv4 and IPv6 addresses.  */
# define AI_ADDRCONFIG	0x0400	/* Use configuration of this host to choose
...
# define EAI_NODATA	-5	/* obsolete: No address associated with NAME.  */
# define EAI_FAMILY	-6	/* `ai_family' not supported.  */
# define EAI_SOCKTYPE	-7	/* `ai_socktype' not supported.  */
# define EAI_SERVICE	-8	/* SERVICE not supported for `ai_socktype'.  */
# define EAI_ADDRFAMILY	-9	/* obsolete: Address family for NAME not supported.  */
...
# define NI_NUMERICSCOPE	0x0020	/* Return numeric socpe-id (if it is needed) */
