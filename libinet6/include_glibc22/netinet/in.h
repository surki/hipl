/* $USAGI: in.h,v 1.9 2005/12/18 10:26:48 yoshfuji Exp $ */
...
extern int inet6_option_space (int _nbytes) __THROW;
extern int inet6_option_init (void *__bp, struct cmsghdr **__cmsgp, int __type) __THROW;
extern int inet6_option_append (struct cmsghdr *__cmsg, const uint8_t *typep,
				    int __multx, int __plusy) __THROW;
extern uint8_t *inet6_option_alloc (struct cmsghdr *__cmsg, int __datalen, 
					 int __multx, int __plusy) __THROW;
extern int inet6_option_next (const struct cmsghdr *__cmsg, uint8_t **__tptrp) __THROW;
...
extern int inet6_rthdr_lasthop (struct cmsghdr *__cmsg, unsigned int __flags) __THROW;
extern int inet6_rthdr_reverse (const struct cmsghdr *__in, struct cmsghdr *__out) __THROW;
extern int inet6_rthdr_segments (const struct cmsghdr *__cmsg) __THROW;
