...
#define IPV6_RXSRCRT		IPV6_RTHDR		/* obsolate name */
#define SCM_SRCRT		IPV6_RXSRCRT		/* obsolete name */

#define IPV6_RXHOPOPTS		IPV6_HOPOPTS		/* obsolete name */
#define IPV6_RXDSTOPTS		IPV6_DSTOPTS		/* obsolete name */
#define IPV6_ADD_MEMBERSHIP	IPV6_JOIN_GROUP		/* obsolete name */
#define IPV6_DROP_MEMBERSHIP	IPV6_LEAVE_GROUP	/* obsolete name */
