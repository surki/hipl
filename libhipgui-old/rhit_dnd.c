...
/******************************************************************************/
/** */
void rh_drag_begin(GtkWidget *tree, GdkDragContext *dc, gpointer data)
{
	/* Variables. */
	GtkTreeIter iter;
	GtkTreeModel *model;
...
/******************************************************************************/
/** */
gboolean rh_drag_motion(GtkWidget *widget, GdkDragContext *dc,
...
/******************************************************************************/
/** */
void rh_drag_data_get(GtkWidget *widget, GdkDragContext *dc,
...
/******************************************************************************/
/** */
gboolean rh_drag_drop(GtkWidget *widget, GdkDragContext *dc,
                      gint x, gint y, guint t, gpointer data)
{
	return FALSE;
}
...
/******************************************************************************/
/** */
void rh_drag_data_received(GtkWidget *tree, GdkDragContext *dc,
