...
#ifdef ANDROID
#    define HIPD_CONFIG_FILE     "/system/etc/hip/hipd_config"
#else
...
#ifdef ANDROID
#    define HIPD_HOSTS_FILE     "/system/etc/hip/hosts"
#else
...
#ifdef ANDROID
#    define HIPD_NSUPDATE_CONF_FILE     "/system/etc/hip/nsupdate.conf"
#else
