...
aes_rval aes_enc_blk_(const unsigned char in_blk[], unsigned char out_blk[], const aes_ctx cx[1])
...
aes_rval aes_dec_blk_(const unsigned char in_blk[], unsigned char out_blk[], const aes_ctx cx[1])
{   aes_32t        locals(b0, b1);
