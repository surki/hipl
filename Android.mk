...
BASE_C_INCLUDES := $(addprefix $(BASE_PATH)/, . hipd libhipandroid libhipcore libhiptool libdht i3 i3/i3_client pjproject/pjlib/include pjproject/pjlib-util/include pjproject/pjnath/include)
...
LOCAL_STATIC_LIBRARIES := libhipcore libhiptool libhipandroid libpjnath-hipl libpj-hipl libpjlib-util-hipl
